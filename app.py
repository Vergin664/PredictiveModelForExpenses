...
def prediction(input_data):
    ...
    pred = final_model.predict_proba(input_data)[:, 1][0]
...
occupation = st.selectbox('Select Occupation', ['Exec-managerial', 'Other-service', 'Prof-specialty', 'Adm-clerical', 
    'Machine-op-inspct', 'Craft-repair', 'Sales', 'Transport-moving', 'Handlers-cleaners', 'Tech-support', 
...
education = st.selectbox('Education:', ['Bachelors', 'Some-college', 'Doctorate', 'HS-grad', 'Assoc-voc', 
    'Masters', '7th-8th', '10th', 'Assoc-acdm', '9th', '11th', 'Prof-school', '12th', '1st-4th', '5th-6th', 'Preschool'])
...
native_country_encoded = label_encoder.transform([native_country])[0] if native_country else 0
